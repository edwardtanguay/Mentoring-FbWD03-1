...
// console.log(customers.slice(0,1));
...
cities.shift();
cities.shift();
smallerList = cities.slice(0, 10);
smallerList.pop();
smallerList.unshift("Potsdam");
smallerList = smallerList.reverse();
smallerList.sort();
console.log(smallerList.indexOf('Berlin'));
console.log(smallerList.indexOf('Bern'));
console.log(smallerList.indexOf('México D.F.'));
console.log(smallerList.lastIndexOf('México D.F.'));

smallerList.splice(smallerList.lastIndexOf('México D.F.')-4, 1, "ERROR");

console.log(smallerList.map(m => `(${m})`).join(' - '));